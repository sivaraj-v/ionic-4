...
CouchDB:
http://localhost:5984/_utils/#/database/dummy/_all_docs


`prettier --print-width=200 --single-quote --jsx-bracket-same-line --arrow-parens always --write -width=200 --trailing-comma=none --write "src/**/*.js"`